...
package org.osmf.elements
{
	...
	public class FailoverF4MLoader extends F4MLoader
	{
		 ...
		 *  @productversion OSMF 1.0
		 */
		public function FailoverF4MLoader(factory:MediaFactory = null)
		{
			if (factory == null)
			{
		...
		override protected function executeLoad(loadTrait:LoadTrait):void
		{
			...
			var manifestRequest:URLRequest = new URLRequest(URLResource(loadTrait.resource).url);
			var manifestLoader:URLLoader = new URLLoader(manifestRequest);
			...
			var retries:int = OSMFSettings.hdsMaximumRetries;
			function onError(event:ErrorEvent):void
			{
				...
				if (retries <= 0) {
					...
					setTimeout(manifestLoader.load, 1000, manifestRequest);
				}
			}
