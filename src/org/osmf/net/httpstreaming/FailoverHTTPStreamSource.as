...
package org.osmf.net.httpstreaming
{
	...
	public class FailoverHTTPStreamSource implements IHTTPStreamSource, IHTTPStreamHandler
	{
		 ...
		 * Default constructor.
		 */
		public function FailoverHTTPStreamSource(factory:HTTPStreamingFactory, resource:MediaResourceBase, dispatcher:IEventDispatcher)
		{
			if (dispatcher == null)
			{
				...
				case HTTPStreamingState.LOAD:
					...
					switch(_request.kind)
					{
						...
						case HTTPStreamRequestKind.BEST_EFFORT_DOWNLOAD:
							...
							if (_downloader == null)
							{
								_downloader = new FailoverHTTPStreamDownloader();
							}
		...
		private var _downloader:FailoverHTTPStreamDownloader = null;
		...
		private var _indexDownloader:FailoverHTTPStreamDownloader = new FailoverHTTPStreamDownloader();
