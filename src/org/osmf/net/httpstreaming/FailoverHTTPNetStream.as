...
package org.osmf.net.httpstreaming
{
	 ...
	 */	
	public class FailoverHTTPNetStream extends NetStream
	{
		/**
		 * Constructor.
		 * 
		 ...
		 */
		public function FailoverHTTPNetStream( connection:NetConnection, factory:HTTPStreamingFactory, resource:URLResource = null)
		{
			super(connection);
			_resource = resource;
			_factory = factory;
		...
		private function changeAudioStreamTo(streamName:String):void
		{
			...
			)
			{
				...
				if (audioResource != null)
				{
					...
					_mixer.audio = new FailoverHTTPStreamSource(_factory, audioResource, _mixer);
		...
		protected function createSource(resource:URLResource):void
		{
			...
			if (streamingResource == null || streamingResource.alternativeAudioStreamItems == null || streamingResource.alternativeAudioStreamItems.length == 0)
			{
				...
				var legacySource:FailoverHTTPStreamSource = new FailoverHTTPStreamSource(_factory, _resource, this);
			...
			{
				_mixer = new FailoverHTTPStreamMixer(this);
				_mixer.video = new FailoverHTTPStreamSource(_factory, _resource, _mixer);
...
//		}
		...
		private var _mixer:FailoverHTTPStreamMixer = null;
