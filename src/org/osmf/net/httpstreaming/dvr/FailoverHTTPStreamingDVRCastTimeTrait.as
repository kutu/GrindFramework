...
package org.osmf.net.httpstreaming.dvr
{
	...
	import org.osmf.net.httpstreaming.FailoverHTTPNetStream;
	...
	{
		public function FailoverHTTPStreamingDVRCastTimeTrait(connection:NetConnection, stream:FailoverHTTPNetStream, dvrInfo:DVRInfo)
		{
			super(NaN);
		...
		private var _stream:FailoverHTTPNetStream;
